...
<head>
	...
	<link rel="stylesheet" href="../CSS/users.css?skssk">
                ...
                <div class='col-12 question-forum2'>  
                    <form action="intermediaire.php" method="get">                                                                                                 
                        ...
                        <button type="submit" class="buttonTest">
                            <a href="intermediaire.php?l=<?php $count; echo $count; ?>" title="cliqué pour toi"><?php echo $rq[$i]['question']."<br>";?></a>
                            <?php foreach($req as $r){?>
                                <span class='info'><?php echo "Publié par ".$r['prenom'];?></span>
                                <span class='info'><?php echo "le ".$rq[$i]['date_demande'];?></span>
                            <?php } ?>
                        </button>
                    </form>                            
                    <?php $count++; ?>  					                                     
